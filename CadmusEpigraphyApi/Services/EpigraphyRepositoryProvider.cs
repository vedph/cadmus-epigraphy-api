...
/// <summary>
/// Cadmus Epigraphy repository provider.
/// </summary>
/// <seealso cref="IRepositoryProvider" />
public sealed class EpigraphyRepositoryProvider : IRepositoryProvider
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EpigraphyRepositoryProvider"/>
    /// class.
    /// </summary>
    /// <param name="configuration">The configuration.</param>
    /// <exception cref="ArgumentNullException">configuration</exception>
    public EpigraphyRepositoryProvider()
    {
        ConnectionString = "";
